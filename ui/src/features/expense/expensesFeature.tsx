...
export default function ExpensesFeature() {
  ...
  const [currentExpense, setCurrentExpense] = useState<Partial<FilteredExpense> | undefined>()
  ...
  if (getAllExpensesLoading || getAllProfilesLoading || getAllAccountsLoading || getAllCategoriesLoading || saveExpenseLoading || updateExpenseLoading || deleteExpenseLoading)
  ...
  if (expensesData && profilesData && accountsData && categoriesData) {
    return (
      <div className="container mx-auto p-4 min-h-screen mb-4">
        ...
        <ExpensesList expensesData={expensesData} categoriesData={categoriesData} accountsData={accountsData} profilesData={profilesData} handleUpdateProfile={handleUpdateProfile} enabledMap={enabledMap} handleDeleteAccount={handleDeleteAccount} />
