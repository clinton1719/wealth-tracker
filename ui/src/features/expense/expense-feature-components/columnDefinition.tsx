...
export function createColumns(handleUpdateProfile: ((updateExpense: UpdateExpense) => void), handleDeleteAccount: ((expenseId: Partial<FilteredExpense>) => void)): ColumnDef<FilteredExpense>[] {
  return [
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-left flex gap-2" style={{ color: row.getValue('categoryColorCode') }}>
          <DynamicIcon
