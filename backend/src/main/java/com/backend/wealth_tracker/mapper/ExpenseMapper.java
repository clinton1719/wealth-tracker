...
public final class ExpenseMapper {
    ...
    public static List<ResponseCategoryExpenseDTO> createResponseCategoryExpenseDTOFromMaps(
            Map<Long, BigDecimal> categoryExpenseMap, Map<Long, Category> categoryMap, Map<Long, Long> profileMap) {
        ...
        for (Map.Entry<Long, BigDecimal> entry : categoryExpenseMap.entrySet()) {
            ...
            Long profileId = profileMap.get(entry.getKey());
            ...
            responseCategoryExpenseDTO.setProfileId(profileId);
    ...
    public static List<ResponseTagExpenseDTO> createResponseTagExpenseDTOFromMaps(
            Map<String, BigDecimal> tagMap, Map<String, Long> profileMap) {
        ...
        for (Map.Entry<String, BigDecimal> entry : tagMap.entrySet()) {
            ...
            responseTagExpenseDTO.setProfileId(profileId);
