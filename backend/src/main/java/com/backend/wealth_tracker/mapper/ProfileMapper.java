...
public final class ProfileMapper {
    ...
    public static Profile createProfileDTOToProfile(CreateProfileDTO createProfileDTO) throws IOException {
    ...
    public static ResponseProfileDTO profileToResponseProfileDTO(Profile profile) {
        ...
        responseProfileDTO.setProfilePicture(profile.getProfilePictureExtension() + Base64.getEncoder().encodeToString(profile.getProfilePicture()));
